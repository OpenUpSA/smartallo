...
import { faShield, faPersonCane, faWheelchair, faPaperclip, faReceipt } from "@fortawesome/free-solid-svg-icons";

import { useAppContext } from './AppContext';

export default function Dashboard() {

	const { criteria, spaces, setSpaces, selectedCriteria, setSelectedCriteria, municipalities, selectedMunicipality, setSelectedMunicipality, pool, setPool } = useAppContext();
	...
	return (
		<>
			<Container fluid className="p-4">
				<Row className="mb-5">
                    <Col>
                        <h1><strong>SMART</strong>ALLO</h1>
                    </Col>
					<Col xs="auto">
						<Dropdown>
